...
class AboutMethods < EdgeCase::Koan
  ...
  def test_sometimes_missing_parenthesis_are_ambiguous
    #eval "assert_equal 5, my_global_method 2, 3" - orig
    eval "assert_equal 5, my_global_method(2, 3)" #changed to use parens.  Wouldn't you always use parens to be specific?
    #
  ...
  def test_method_without_explicit_return
    ...
    # I take it non explicit return methods just return last value in method
  end
  ...
  def test_calling_methods_in_same_class_with_explicit_receiver
    ...
    # is the only thing to learn from this lesson that I can call methods by declaring what class I'm in or not?
    # similar to C# 'this'
  end
