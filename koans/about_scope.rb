...
class AboutScope < EdgeCase::Koan
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    ...
    assert_equal 165, Object.constants.size
    # not sure if I was supposed to know or be able to figure out the 155 answer without 
    # running the test and viewing the output first.  
    
    # I also had to update this as I added classes on my way to enlightenment
  end
end
